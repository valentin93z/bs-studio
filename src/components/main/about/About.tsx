...
import about01 from '../../../img/about01.jpg';
  ...
  return (
    <section className={classes.about}>
        ...
        <div className={classes.about__content}>
          <div>
            <p className={classes.about__text}>Наша студия Diva Nail делает всё для того, чтобы предоставлять превосходное качество работ нашим гостям и оказывать сервис высокого уровня.</p>
            <p className={classes.about__text}>Уютная и комфортная обстановка, приветливый персонал забота о вас - визитная карточка нашей студии.</p>
            <img className={classes.about__image} src={about01} alt="about" />
          </div>
          <div>
            ...
            <p className={classes.about__text}>От нас вы уйдете с чувством легкости и обновления, и приятные чувства останутся с вами до следующего посещения, потому что мы работаем для Вас.</p>
            <img className={classes.about__image} src={about02} alt="about" />
          </div>
        </div>
    </section>
  )
